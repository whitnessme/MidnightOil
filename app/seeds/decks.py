...
def seed_decks():
    ...
    beginner_html = Deck(owner_id=1, user_id=1, name='Beginner HTML', about='Memorize! Memorize!', size=15)
    order_of_operations = Deck(owner_id=1, user_id=1, name='Math Grade 1', about='', size=10)
